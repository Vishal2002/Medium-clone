...
// .wrangler/tmp/bundle-kJk6Om/checked-fetch.js
...
// .wrangler/tmp/bundle-kJk6Om/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-kJk6Om/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var upload = new HonoS3Storage({
  key: (_, file) => `${file.originalname}-${(/* @__PURE__ */ new Date()).getTime()}.${file.extension}`,
  bucket: "BUCKET_NAME",
...
blogRouter.post("/blogs", upload.single("image"), async (c2) => {
  try {
